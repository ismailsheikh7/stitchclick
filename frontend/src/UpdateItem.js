...
const UpdateItemss = async () => {
    const ItemData = {ItemId: ItemId, ItemName: ItemName, ItemImage: ItemImage, ItemDescription: ItemDescription, ItemPrice: ItemPrice };
   console.log(ItemData)
    ...
    <Navbar1/>
       ...
       <h1 id="H1p2" style={{paddingLeft:"25px"}}>Update Items</h1>
        ...
        <button id="btnform4" onClick={UpdateItemss}> Update</button>
      </div>
</div>
     );
}
